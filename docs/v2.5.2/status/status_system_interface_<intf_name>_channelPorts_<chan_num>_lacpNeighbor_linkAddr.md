...
ighbor/linkAddr</member_intf_name>

Use

Use to view the interface MAC address.
...
e/name/channelPorts/name/lacpNeighbor/linkAddr
...
GET Response
    ...
    {"httpResponseCode": 404,
     ...
     "recurse": False,
     "requestPath": "/status/system/interface/name/channelPorts/name/lacpNeighbor/linkAddr"}
    

  1. /status/system/interface/<intf_name>/channelPorts/<member_intf_name>/lacpNeighbor/linkAddr</member_intf_name>
    1. Parameters
    2. Data Key
      1. Data Type
