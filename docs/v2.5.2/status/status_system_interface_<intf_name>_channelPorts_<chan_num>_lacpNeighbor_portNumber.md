...
ighbor/portNumber</member_intf_name>

Use

Use to view the port number that the switch assigned to this interface for
LACP.
...
e/name/channelPorts/name/lacpNeighbor/portNumber
...
GET Response
    ...
    {"httpResponseCode": 404,
     ...
     "recurse": False,
     "requestPath": "/status/system/interface/name/channelPorts/name/lacpNeighbor/portNumber"}
    

  1. /status/system/interface/<intf_name>/channelPorts/<member_intf_name>/lacpNeighbor/portNumber</member_intf_name>
    1. Parameters
    2. Data Key
      1. Data Type
