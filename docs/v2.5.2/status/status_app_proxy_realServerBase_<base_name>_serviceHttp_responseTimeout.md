## /status/app/proxy/realServerBase/<base_name>/serviceHttp/responseTimeout
...
GET Response
    ...
    {"/status/app/proxy/realServerBase/rsb1/serviceHttp/responseTimeout": {"data": 1.5,
                                                                           "default": False,
                                                                           "defaultAllowed": True,
                                                                           "deleteAllowed": False,
                                                                           "numChildren": 0,
     ...
     "recurse": False,
     "requestPath": "/status/app/proxy/realServerBase/rsb1/serviceHttp/responseTimeout"}
    

  1. /status/app/proxy/realServerBase/<base_name>/serviceHttp/responseTimeout
    1. Parameters
    2. Data Key
      1. Data Type
