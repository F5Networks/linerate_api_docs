## /status/app/proxy/stats/data/virtualServer/<name>/proxyTotalQueueSize
...
s/data/virtualServer/vs1/proxyTotalQueueSize

GET Response

    
    
    {"/status/app/proxy/stats/data/virtualServer/vs1/proxyTotalQueueSize": {"data": 0,
                                                                               "default": False,
     ...
     "recurse": False,
     "requestPath": "/status/app/proxy/stats/data/virtualServer/vs1/proxyTotalQueueSize"}
    

  1. /status/app/proxy/stats/data/virtualServer/<name>/proxyTotalQueueSize
    1. Parameters
    2. Data Key
      1. Data Type
