##
/status/app/proxy/stats/data/forwardProxy/<name>/proxyServerQueueSize5MinAvg
...
/data/forwardProxy/fp-01/proxyServerQueueSize5MinAvg

GET Response

    
    {"/status/app/proxy/stats/data/forwardProxy/fp-01/proxyServerQueueSize5MinAvg": {"data": 0,
                                                                                      "default": False,
     ...
     "recurse": False,
     "requestPath": "/status/app/proxy/stats/data/forwardProxy/fp-01/proxyServerQueueSize5MinAvg"}
    

  1. /status/app/proxy/stats/data/forwardProxy/<name>/proxyServerQueueSize5MinAvg
    1. Parameters
    2. Data Key
      1. Data Type
