...
REST API Reference - [backup](https://docs.lineratesystems.com/093Release_2.5/
250REST_API_Reference_Guide/exec/system/util/backup)

REST API Reference - [restore](https://docs.lineratesystems.com/093Release_2.5
/250REST_API_Reference_Guide/exec/system/util/restore)

REST API Reference - [u](https://docs.lineratesystems.com/093Release_2.5/250RE
ST_API_Reference_Guide/exec/system/util/upgrade)[pgrade](https://docs.linerate
systems.com/093Release_2.5/250REST_API_Reference_Guide/exec/system/util/upgrad
e)
...
CLI Reference - [Upgrade Command](https://docs.lineratesystems.com/093Release_
2.5/200CLI_Reference_Guide/Exec_Commands/Upgrade_Command)
