##
/status/app/proxy/virtualServer/<name>/serviceHttp/requestRateLimitBurstSize
...
GET Response
    ...
    {"/status/app/proxy/virtualServer/vs-01/serviceHttp/requestRateLimitBurstSize": {"default": True,
                                                                                      "defaultAllowed": True,
                                                                                      "deleteAllowed": False,
                                                                                      "numChildren": 0,
                                                                                      "type": "uint32"},
     ...
     "recurse": False,
     "requestPath": "/status/app/proxy/virtualServer/vs-01/serviceHttp/requestRateLimitBurstSize"}
    

  1. /status/app/proxy/virtualServer/<name>/serviceHttp/requestRateLimitBurstSize
    1. Parameters
    2. Data Key
      1. Data Type
