## /status/system/interface/<intf_name>/channelGroup/channelNumber

Use

Use to view the port channel group number.
...
GET Response
    ...
    {"httpResponseCode": 404,
     ...
     "recurse": False,
     "requestPath": "/status/system/interface/name/channelGroup/channelNumber"}
    

  1. /status/system/interface/<intf_name>/channelGroup/channelNumber
    1. Parameters
    2. Data Key
      1. Data Type
