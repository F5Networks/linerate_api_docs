...
<span id=".2Fexec.2Fclear.2Fip.2Fv4.2Froute"></span>
<h2 class="editable">/exec/clear/ip/v4/route</h2>
<p></p>
...
<p>GET</p>
<p>curl -b cookie.jar -k https://10.1.2.3:8443/lrs/api/v1.0/exec/clear/ip/v4/route</p>
<p>GET Response</p>
<pre><code>{&quot;/exec/clear/ip/v4/route&quot;: {&quot;data&quot;: None,
                              &quot;default&quot;: False,
 ...
 &quot;recurse&quot;: False,
 &quot;requestPath&quot;: &quot;/exec/clear/ip/v4/route&quot;}</code></pre>
<p>PUT</p>
<p>curl -b cookie.jar --data @data.json -k -H &quot;Content-Type: application/json&quot; -X PUT https://10.1.2.3:8443/lrs/api/v1.0/exec/clear/ip/v4/route</p>
<p>PUT Response</p>
...
<ol>
<li><a href="#.2Fexec.2Fclear.2Fip.2Fv4.2Froute">/exec/clear/ip/v4/route</a>
<ol>
