...
<span id=".2Fstatus.2Fscript.2F.3Cname.3E.2FlastError"></span>
<h2 class="editable">/status/script/&lt;name&gt;/lastError</h2>
<p><span>The nodes below this one perform the functions described in this function overview.</span></p>
<div class="lrs-Subhead style-wrap">
<p>Use</p>
</div>
<p>Use to see the information about the script's last error.</p>
...
<p>GET</p>
<p>curl -b cookie.jar -k https://host-56:8443/lrs/api/v1.0/status/script/sc-01/lastError</p>
<p>GET Response</p>
<pre><code>   </code></pre>
</div>
</div>
...
<ol>
<li><a href="#.2Fstatus.2Fscript.2F.3Cname.3E.2FlastError">/status/script/&lt;name&gt;/lastError</a>
<ol>
