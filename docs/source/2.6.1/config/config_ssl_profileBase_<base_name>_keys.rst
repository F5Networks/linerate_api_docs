...
<span id=".2Fconfig.2Fssl.2FprofileBase.2F.3Cbase_name.3E.2Fkeys"></span>
<h2 class="editable">/config/ssl/profileBase/&lt;base_name&gt;/keys</h2>
<p></p>
...
<p>GET</p>
<p>curl -b cookie.jar -k https://host-128:8443/lrs/api/v1.0/config/ssl/profileBase/spb-01/keys</p>
</div>
</div>
</div>
<ol>
<li><a href="#.2Fconfig.2Fssl.2FprofileBase.2F.3Cbase_name.3E.2Fkeys">/config/ssl/profileBase/&lt;base_name&gt;/keys</a>
<ol>
