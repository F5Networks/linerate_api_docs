...
Backs up all files for the current version of F5® LineRate®, including all
configuration and files. When you create a full backup, you can use it to do
either a quick or full restore.
...
PUT https://10.1.2.3:8443/lrs/api/v1.0/exec/system/util/backup/full
...
PUT Response
  ...
  1. /exec/system/util/backup/full
    1. Data Key
      1. Data Type
    2. Default Allowed
    3. Request Methods
