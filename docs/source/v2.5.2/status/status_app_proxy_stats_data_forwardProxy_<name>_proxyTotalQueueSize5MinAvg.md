## /status/app/proxy/stats/data/forwardProxy/<name>/proxyTotalQueueSize5MinAvg
...
/data/forwardProxy/fp-01/proxyTotalQueueSize5MinAvg

GET Response

    
    {"/status/app/proxy/stats/data/forwardProxy/fp-01/proxyTotalQueueSize5MinAvg": {"data": 0,
                                                                                     "default": False,
     ...
     "recurse": False,
     "requestPath": "/status/app/proxy/stats/data/forwardProxy/fp-01/proxyTotalQueueSize5MinAvg"}
    

  1. /status/app/proxy/stats/data/forwardProxy/<name>/proxyTotalQueueSize5MinAvg
    1. Parameters
    2. Data Key
      1. Data Type
