## /status/app/proxy/realServer/<name>/sslProfile/origin
...
Server/rs1/sslProfile/origin

GET Response

    
    {"/status/app/proxy/realServer/rs1/sslProfile/origin": 
     ...
     "recurse": False,
     "requestPath": "/status/app/proxy/realServer/rs1/sslProfile/origin"}
    

  1. /status/app/proxy/realServer/<name>/sslProfile/origin
    1. Parameters
    2. Data Key
      1. Data Type
