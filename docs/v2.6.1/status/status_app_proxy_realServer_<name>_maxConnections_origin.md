## /status/app/proxy/realServer/<name>/maxConnections/origin
...
Server/rs1/maxConnections/origin

GET Response

    
    {"/status/app/proxy/realServer/rs1/maxConnections/origin": {"data": "/config/app/proxy/realServerBase/rsb1",
                                                                "default": False,
     ...
     "recurse": False,
     "requestPath": "/status/app/proxy/realServer/rs1/maxConnections/origin"}
    

  1. /status/app/proxy/realServer/<name>/maxConnections/origin
    1. Parameters
    2. Data Key
      1. Data Type
