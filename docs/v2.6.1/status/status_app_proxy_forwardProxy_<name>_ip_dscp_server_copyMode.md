## /status/app/proxy/forwardProxy/<name>/ip/dscp/server/copyMode

Use

Use to view the status (enabled or disabled) for copying of the DSCP bits from
the client for traffic to the server.
...
GET Response
    ...
    {"/status/app/proxy/forwardProxy/fp-01/ip/dscp/server/copyMode": {"data": 1,
                                                                       "default": False,
                                                                       "defaultAllowed": True,
                                                                       "deleteAllowed": False,
                                                                       "numChildren": 0,
     ...
     "recurse": False,
     "requestPath": "/status/app/proxy/forwardProxy/fp-01/ip/dscp/server/copyMode"}
    

  1. /status/app/proxy/forwardProxy/<name>/ip/dscp/server/copyMode
    1. Parameters
    2. Data Key
      1. Data Type
      2. Data Values
