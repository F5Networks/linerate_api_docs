...
tor/key</member_intf_name>

Use

Use to view what the system is calling the key for the interface.
...
e/name/channelPorts/name/lacpActor/key
...
GET Response
    ...
    {"httpResponseCode": 404,
     ...
     "recurse": False,
     "requestPath": "/status/system/interface/name/channelPorts/name/lacpActor/key"}
    

  1. /status/system/interface/<intf_name>/channelPorts/<member_intf_name>/lacpActor/key</member_intf_name>
    1. Parameters
    2. Data Key
      1. Data Type
