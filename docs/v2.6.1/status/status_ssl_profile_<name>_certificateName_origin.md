## /status/ssl/profile/<name>/certificateName/origin
...
-01/certificateName/origin

GET Response

    
    {"/status/ssl/profile/sp-01/certificateName/origin": {"data": "/config/ssl/profile/sp-01",
                                                           "default": False,
     ...
     "recurse": False,
     "requestPath": "/status/ssl/profile/sp-01/certificateName/origin"}
    

  1. /status/ssl/profile/<name>/certificateName/origin
    1. Parameters
    2. Data Key
      1. Data Type
