## /status/system/build/username

Use

Use to view the internal user who built the current build.
...
curl -b cookie.jar -k
https://10.1.2.3:8443/lrs/api/v1.0/status/system/build/username

GET Response

    
    {"/status/system/build/username": {"data": "longstaf",
                                        "default": False,
     ...
     "recurse": False,
     "requestPath": "/status/system/build/username"}
    

  1. /status/system/build/username
    1. Data Key
      1. Data Type
