...
ighbor/sysId</member_intf_name>

Use

Use to view the system ID, so that you can match it to the ID on the system.
...
e/name/channelPorts/name/lacpNeighbor/sysId
...
GET Response
    ...
    {"httpResponseCode": 404,
     ...
     "recurse": False,
     "requestPath": "/status/system/interface/name/channelPorts/name/lacpNeighbor/sysId"}
    

  1. /status/system/interface/<intf_name>/channelPorts/<member_intf_name>/lacpNeighbor/sysId</member_intf_name>
    1. Parameters
    2. Data Key
      1. Data Type
