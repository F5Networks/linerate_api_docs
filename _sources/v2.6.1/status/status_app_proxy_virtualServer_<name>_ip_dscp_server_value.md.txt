## /status/app/proxy/virtualServer/<name>/ip/dscp/server/value
...
GET Response
    ...
    {"/status/app/proxy/virtualServer/vs-01/ip/dscp/server/value": {"default": True,
                                                                     "defaultAllowed": True,
                                                                     "deleteAllowed": False,
                                                                     "numChildren": 0,
                                                                     "type": "uint32"},
     ...
     "recurse": False,
     "requestPath": "/status/app/proxy/virtualServer/vs-01/ip/dscp/server/value"}
    

  1. /status/app/proxy/virtualServer/<name>/ip/dscp/server/value
    1. Parameters
    2. Data Key
      1. Data Type
