## /status/app/proxy/realServer/<name>/serviceHttp/requestRateLimit/origin
...
Server/rs1/serviceHttp/requestRateLimit/origin

GET Response

    
    {"/status/app/proxy/realServer/rs1/serviceHttp/requestRateLimit/origin": {"data": "default",
                                                                                    "default": False,
     ...
     "recurse": False,
     "requestPath": "/status/app/proxy/realServer/rs1/serviceHttp/requestRateLimit/origin"}
    

  1. /status/app/proxy/realServer/<name>/serviceHttp/requestRateLimit/origin
    1. Parameters
    2. Data Key
      1. Data Type
