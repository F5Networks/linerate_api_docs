## /status/failover/group/<group_name>/elements/<element/>

Use

Use to view status information for this member interface.
...
The data key contains the name of the element identification in the format
defined in Parameters above.
...
curl -b cookie.jar -k
https://host-43:8443/lrs/api/v1.0/status/failover/group/name/elements/name
...
GET Response
    ...
    {"httpResponseCode": 404,
     ...
     "recurse": False,
     "requestPath": "/status/failover/group/name/elements/name"}
    

GET (list children)

curl -b cookie.jar -k https://host-43:8443/lrs/api/v1.0/status/failover/group/
name/elements/name?op=list
...
curl -b cookie.jar -k https://host-43:8443/lrs/api/v1.0/status/failover/group/
name/elements/name?level=recurse

  1. /status/failover/group/<group_name>/elements/<element/>
    1. Parameters
    2. Data Key
      1. Data Type
