## /config/system/scheduler/cpu/manual/health

Use

This is the process for the health monitor. Use only when directed by
...
curl -b cookie.jar -k
https://10.1.2.3:8443/lrs/api/v1.0/config/system/scheduler/cpu/manual/health

GET Response

    
    {"/config/system/scheduler/cpu/manual/health": {"data": "",
                                                     "default": False,
...
PUT Response
  ...
  1. /config/system/scheduler/cpu/manual/health
    1. Data Key
      1. Data Type
