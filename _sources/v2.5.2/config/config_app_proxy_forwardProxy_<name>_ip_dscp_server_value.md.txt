## /config/app/proxy/forwardProxy/<name>/ip/dscp/server/value
...
GET Response
    ...
    {"/config/app/proxy/forwardProxy/fp-01/ip/dscp/server/value": {"default": True,
                                                                    "defaultAllowed": True,
                                                                    "deleteAllowed": False,
                                                                    "numChildren": 0,
                                                                    "type": "uint32"},
...
PUT Response
  ...
  1. /config/app/proxy/forwardProxy/<name>/ip/dscp/server/value
    1. Parameters
    2. Data Key
      1. Data Type
