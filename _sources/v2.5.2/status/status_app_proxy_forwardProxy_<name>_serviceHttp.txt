## /status/app/proxy/forwardProxy/<name>/serviceHttp
...
Use to view options configured for HTTP services.
...
GET Response
    ...
    {"/status/app/proxy/forwardProxy/fp-01/serviceHttp": {"data": None,
                                                           "default": False,
     ...
     "recurse": False,
     "requestPath": "/status/app/proxy/forwardProxy/fp-01/serviceHttp"}
    

  1. /status/app/proxy/forwardProxy/<name>/serviceHttp
    1. Parameters
      1. Data Type
