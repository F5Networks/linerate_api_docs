## /status/app/proxy/forwardProxy/<name>/ip/dscp/client/copyMode

Use

Use to view the status (enabled or disabled) for copying of the DSCP bits from
the server for traffic to the client.
...
GET Response
    ...
    {"/status/app/proxy/forwardProxy/fp-01/ip/dscp/client/copyMode": {"default": True,
                                                                       "defaultAllowed": True,
                                                                       "deleteAllowed": False,
                                                                       "numChildren": 0,
                                                                       "type": "uint32"},
     ...
     "recurse": False,
     "requestPath": "/status/app/proxy/forwardProxy/fp-01/ip/dscp/client/copyMode"}
    

  1. /status/app/proxy/forwardProxy/<name>/ip/dscp/client/copyMode
    1. Parameters
    2. Data Key
      1. Data Type
      2. Data Values
