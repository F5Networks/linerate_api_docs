## /status/system/interface/<name>/channelPorts/<name>/lacpNeighbor/systemPrio
rity
...
e/name/channelPorts/name/lacpNeighbor/systemPriority
...
GET Response
    ...
    {"httpResponseCode": 404,
     ...
     "recurse": False,
     "requestPath": "/status/system/interface/name/channelPorts/name/lacpNeighbor/systemPriority"}
    

  1. /status/system/interface/<name>/channelPorts/<name>/lacpNeighbor/systemPriority
    1. Parameters
    2. Data Key
      1. Data Type
