...
#
# This script is based on one authored by https://gist.github.com/hugorodgerbrown/5317616.
# It will convert a directory full .html files into .rst equivalents. It uses
